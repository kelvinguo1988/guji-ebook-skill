...
PDF = sys.argv[1] if len(sys.argv) > 1 else os.path.join(ROOT, '道德经三版本对照笺注-第一章样章.pdf')
OUT = sys.argv[2] if len(sys.argv) > 2 else os.path.join(ROOT, '道德经三版本对照笺注-第一章样章-版式本.epub')
